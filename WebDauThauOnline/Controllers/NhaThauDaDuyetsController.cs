...
namespace WebDauThauOnline.Controllers
{
    public class NhaThauDaDuyetsController : Controller
    {
        ...
        public ActionResult Create(NhaThauDaDuyet nhaThauDaDuyet)
        {
            ...
            nhaThauDaDuyet.Loại_đăng_ký = nhaThauDaDuyet.Loại_đăng_ký_EnumValue.ToDescriptionString();
            ...
            nhaThauDaDuyet.Trạng_thái = "Chưa được phê duyệt";
        ...
        public ActionResult GetList(int? page)
        {
            ...
            int pageSize = 10;
            int pageNumber = (page ?? 1);
            NhaThauSearchViewModel.NhaThauDaDuyetModel = db.NhaThauDaDuyets.Where(x=>x.Trạng_thái=="Đã được phê duyệt").OrderBy(x => x.ID).ToPagedList(pageNumber, pageSize);
        ...
        public ActionResult GetList(NhaThauSearchViewModel NhaThauSearchViewModel, int? page)
        {
            ...
            this.NhaThauSearchViewModel = NhaThauSearchViewModel;
            var searchModel = NhaThauSearchViewModel.NhaThauSearchModel;
            var result = db.NhaThauDaDuyets.Where(x => x.Trạng_thái == "Đã được phê duyệt").AsEnumerable();
