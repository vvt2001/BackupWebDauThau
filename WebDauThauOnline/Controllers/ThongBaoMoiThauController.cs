...
namespace WebDauThauOnline.Controllers
{
    public class ThongBaoMoiThauController : Controller
    {
        ...
        public ActionResult Create(ThongBaoMoiThauViewModel ThongBaoMoiThauViewModel)
        {
            ...
            ThongBaoMoiThauViewModel.ThongBaoMoiThauModel.Loại_thông_báo = ThongBaoMoiThauViewModel.ThongBaoMoiThauModel.Loại_thông_báo_EnumValue.ToDescriptionString();
...
/*            db.ThongBaoMoiThau_ThongTinChiTiet.Add(ThongBaoMoiThauViewModel.ThongBaoMoiThauModel);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            thongBaoMoiThauViewModel.ThongBaoMoiThauModel.Loại_thông_báo_EnumValue = EnumExtension.GetValueFromDescription<Loại_thông_báo>(thongBaoMoiThau_ThongTinChiTiet.Loại_hợp_đồng);
