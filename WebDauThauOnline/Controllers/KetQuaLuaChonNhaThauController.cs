...
namespace WebDauThauOnline.Controllers
{
    public class KetQuaLuaChonNhaThauController : Controller
    {
        ...
        public ActionResult Create(int? id)
        {
            ...
            ketQuaLuaChonNhaThauViewModel.ThongBaoMoiThau_ThongTinChiTiet.Loại_thông_báo_EnumValue = EnumExtension.GetValueFromDescription<Loại_thông_báo>(ketQuaLuaChonNhaThauViewModel.ThongBaoMoiThau_ThongTinChiTiet.Loại_hợp_đồng);
            ...
            ViewBag.Loại_thông_báo_EnumList = new SelectList(Loại_thông_báo_EnumData, "ID", "Name");
        ...
        public ActionResult Create(KetQuaLuaChonNhaThauViewModel ketQuaLuaChonNhaThauViewModel)
        {
            ...
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo = ketQuaLuaChonNhaThauViewModel.ThongBaoMoiThau_ThongTinChiTiet.Loại_thông_báo_EnumValue.ToDescriptionString();
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Số_TBMT = ketQuaLuaChonNhaThauViewModel.ThongBaoMoiThau_ThongTinChiTiet.Số_TBMT;
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Số_hiệu_KHLCNT = ketQuaLuaChonNhaThauViewModel.ThongBaoMoiThau_ThongTinChiTiet.Số_hiệu_KHLCNT;
            ...
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Ngày_phê_duyệt = DateTime.Now;
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ketQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo_EnumValue = EnumExtension.GetValueFromDescription<Loại_thông_báo>(ketQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo);
        ...
        public ActionResult Edit(KetQuaLuaChonNhaThauViewModel ketQuaLuaChonNhaThauViewModel)
        {
            ...
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo = ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo_EnumValue.ToDescriptionString();
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Hình_thức_lựa_chọn_NT = ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Hình_thức_lựa_chọn_NT_EnumValue.ToDescriptionString();
            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Hình_thức_hợp_đồng = ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Hình_thức_hợp_đồng_EnumValue.ToDescriptionString();

            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Ngày_đăng_tải = DateTime.Now;

            ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo_EnumValue = EnumExtension.GetValueFromDescription<Loại_thông_báo>(ketQuaLuaChonNhaThauViewModel.KetQuaLuaChonNhaThau_ThongTinChiTiet.Loại_thông_báo);
